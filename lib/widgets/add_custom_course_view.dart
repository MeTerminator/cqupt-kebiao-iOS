      ...
      children: List.generate(10, (index) {
        return GestureDetector(
          ...
          child: Container(
            ...
            height: 34,
            decoration: BoxDecoration(
              color: ColorExtensions.dynamicCourseColor(index: index, total: 10),
              shape: BoxShape.circle,
              border: _colorIndex == index ? Border.all(color: isDark ? Colors.white : Colors.black, width: 2) : null,
            ),
            child: _colorIndex == index ? const Icon(Icons.check, color: Colors.white, size: 18) : null,
          ),
        );
      }),
    );
